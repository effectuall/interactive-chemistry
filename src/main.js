const PNM_MODULE = {
  ...
  topics: [
    { id: 't1', label: 'Solids, Liquids & Gases', content: '<h1 class="text-3xl font-bold mb-4">States of Matter</h1> <p>Particles behave differently in solids, liquids, and gases...</p>', iframe: './SIMS/StatesOfMatter.html' },
    { id: 't2', label: 'Diffusion', content: '<h1 class="text-3xl font-bold mb-4">Diffusion</h1><p>Diffusion is the process of particles spreading from areas of high concentration to low concentration...</p>', iframe: './SIMS/Interactive3DDiffusion.html' },
    { id: 't3', label: 'Kinetic Theory', content: `<h1 class="text-3xl font-bold mb-4">States of Matter</h1> <img src="./assets/states-of-matter.png" alt="Three states of matter displayed side by side: solid particles arranged in tight, ordered grid pattern; liquid particles loosely packed with space between them; gas particles widely dispersed throughout container. Educational diagram with blue background and labeled sections." class="w-full rounded-lg mb-4"><p>Particles behave differently in solids, liquids, and gases...</p>`, iframe: 'https://effectuall.github.io/Simulations/Thermodynamics_Kinetic_Theory_of_Gases.html' },
    { id: 't4', label: 'Changes of State', content: '<h1 class="text-3xl font-bold mb-4">Phase Changes</h1><p>Energy drives the transitions...</p>', iframe: './SIMS/InteractiveStateChange.html' },
    { id: 't5', label: 'Electrochemical Cell', content: '<h1 class="text-3xl font-bold mb-4">Electrochemical Cell</h1><p>Explore the principles of electrochemical cells...</p>', iframe: './SIMS/ElectrochemicalCell.html' }
  ],
  materials: {
